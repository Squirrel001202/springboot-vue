...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES (1, '大学物理', 10, '40', 0,null);
INSERT INTO `course` VALUES (2, '高等数学', 10, '45', NULL,null);
INSERT INTO `course` VALUES (3, '大学英语', 10, '30', NULL,null);
...
CREATE TABLE `sys_user`  (
  ...
  `password` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 123 COMMENT '密码',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` (id,username,password,nickname,email,phone,address,role) VALUES (1, 'admin', 'admin', 'admin', 'admin@qq.com', '13988997788', '安徽合肥', '2022-01-22 21:10:27',  'ROLE_ADMIN');
